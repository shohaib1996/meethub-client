        ...
        <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
          <div>
            ...
            <ul className="flex mt-12 space-x-4">
              <Button className=" h-10 w-10 rounded-full flex items-center justify-center shrink-0">
          ...
          <div className="bg-gray-100 p-6 rounded-lg">
            <form className="mt-8 space-y-4">
              <input
                type="text"
                placeholder="Name"
                className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#4096FF]"
              />
              <input
                type="email"
                placeholder="Email"
              ...
              <textarea
                placeholder="Message"
                rows={6}
                className="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#4096FF]"
                defaultValue={""}
              />
              <Button
                type="primary"
